// Official provider marks for "Sign in with…" buttons.
...
export function providerMark(id: string, size = 20) {
  if (id === "google") return <GoogleMark size={size} />;
  if (id === "linkedin") return <LinkedInMark size={size} />;
  if (id === "facebook") return <FacebookMark size={size} />;
  return null;
}
